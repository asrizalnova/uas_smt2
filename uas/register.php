...
<head>
    ...
    <title>ASRIZAL NOVA AKHSANU UAS WEB</title>
...
<body>
    <div class="topbar">
        <h3 class="text-topbar">UAS WEB Asrizal Nova Akhsanu | 223307036</h3>
    </div>
        ...
        <div class="card-login">
            <div class="card-main">
                ...
                <div class="card-body">
                    ...
                    <p style="text-align: center;">Sudah punya akun?<span><a href="index.php" class=""> Masuk disini</a></span></p>
                </div>
            </div>
        </div>
    </div>
